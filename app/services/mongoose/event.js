...
const getAllEvents = async (req) => {
  ...
  // jadi nampilin datanya berdasarkan user yang login
  // jadi user yang login apa, terus organizernya apa,
  // di memfilter berdasarkan organizernya
  // jadi data organizer a, tidak bisa melihat data organizer , kecuali untuk user participan
...
const updateEvents = async (req) => {
  ...
  // cari event berdasarka field id
